...
VALUES  ('P0001', 1, 15000000, 1),
        ('P0002', 1, 13000000, 1);

INSERT INTO orders_detail (id_product, id_order, price, quantity)
VALUES  ('P0001', 2, 15000000, 1),
        ('P0003', 2, 1000000, 1);
        
INSERT INTO orders_detail (id_product, id_order, price, quantity)
VALUES  ('P0002', 3, 13000000, 1),
        ('P0004', 3, 250000, 1);
...
SELECT orders.id, products.name, products.id, orders_detail.quantity, orders_detail.price
FROM orders
JOIN orders_detail ON (orders_detail.id_order = orders.id)
JOIN products ON (products.id = orders_detail.id_product);